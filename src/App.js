...
export default function CondoMessenger() {
  ...
  const subCategorieManut = [
    "Antennista","Ascensore","Cancelli Elettrici","Disinfestazioni/Derattizzazioni","Edilizia","Elettricista","Fabbro","Giardinaggio","Idraulico","Impianto di Riscaldamento","Montascale"
  ];
        ...
        <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-neutral-600">
            ...
            <div className="text-center sm:text-right text-xs text-neutral-500">
              v8.1 – Ultimo aggiornamento: {new Date().toLocaleDateString('it-IT')}
            </div>
          </div>
        </div>
      </footer>
