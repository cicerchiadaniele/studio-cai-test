...
// ─────────────────────────────────────────────────────────────
// Build constants (v9.1)
// ─────────────────────────────────────────────────────────────
const APP_VERSION = "9.1";
const BUILD_DATE_LABEL = "11/09/2026"; // Data fissa della release, non cambia ogni giorno
...
export default function CondoMessenger() {
  ...
  const validate = (f) => {
    ...
    if (f.categoria === "Invio Documenti") {
      if (!f.file) errs.push("Carica un file");
