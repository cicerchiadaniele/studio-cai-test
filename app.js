...
function initForm(){
  ...
  // Comodità: porta subito il focus sul codice dipendente se non già scelto
...
function wireDateShortcuts(){
  ...
  const toISO = (d) => {
    // formato locale YYYY-MM-DD, evita slittamenti di fuso
...
function showValidityErrors(form){
  ...
  // forza i messaggi del browser e porta in vista il primo campo non valido
...
async function onSubmit(ev){
  ...
  try {
    ...
    const recap = `Cod. ${payload.employee_id} · ${payload.event_type}`;
