...
const IMPRONTA_PAROLA =
  "7f8056de1d99a94866f249434b78965b19f6c63fd7083f686747d326580355dc";

const CONFIG_PREDEFINITA = {
  webhook_url: "https://hook.eu1.make.com/INSERISCI-QUI-IL-TUO-WEBHOOK",
...
function collegaEventi() {
  ...
  $("#btn-suggerimento").addEventListener("click", (e) => {
...
async function controlla() {
  ...
  if (!parola.value.trim()) {
    ...
    mostraErrore("#errore-parola", "Questa parola chiave non è quella giusta. Riprova: tutto attaccato, in minuscolo.");
    parola.setAttribute("aria-invalid", "true");
    ok = false;
  } else {
...
async function consegna(ev) {
  ...
  const comune = {
    ...
    // sempre normalizzata: in Make il confronto è con "quelramodellagodicomo"
